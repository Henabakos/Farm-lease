      ...
      <div className="flex-1 flex flex-col p-8 md:p-16 lg:p-24 justify-center relative overflow-hidden">
        ...
        >
          ...
          <div className="space-y-2">
            ...
            <p className="text-slate-500 text-base font-normal leading-relaxed">{subtitle}</p>
          </div>
          ...
          <div className="pt-6 flex items-center gap-6 text-slate-400">
            ...
            <div className="flex items-center gap-2">
              ...
              <span className="text-[9px] font-bold uppercase tracking-wider">Instant</span>
            </div>
          </div>
        </motion.div>
      </div>
      ...
      <div className="hidden lg:flex flex-1 bg-[#020617] relative overflow-hidden items-center justify-center p-16">
        ...
        <div className="relative z-10 w-full max-w-xl space-y-16">
          ...
          <motion.div 
            ...
            className="bg-white/[0.03] backdrop-blur-3xl rounded-lg p-8 border border-white/10 shadow-2xl space-y-6 relative group"
          >
            <div className="flex items-center justify-between">
              <div className="space-y-0.5">
                <h3 className="text-xl font-bold text-white tracking-tight">Portfolio Performance</h3>
                <p className="text-white/40 text-[10px] font-bold uppercase tracking-widest">Real-time Analytics</p>
              </div>
              ...
              <ResponsiveContainer width="100%" height="100%">
                <LineChart data={lineData}>
                  ...
                  <Line 
                    ...
                    stroke="#0d9488" 
                    strokeWidth={3} 
                    dot={{ r: 4, fill: '#0d9488', strokeWidth: 2, stroke: '#020617' }} 
                    activeDot={{ r: 6, fill: '#fff', strokeWidth: 3, stroke: '#0d9488' }}
                  />
                  <Tooltip 
                    contentStyle={{ backgroundColor: '#020617', borderRadius: '8px', border: '1px solid rgba(255,255,255,0.1)', boxShadow: '0 10px 15px -3px rgba(0,0,0,0.5)' }}
            ...
            <motion.div 
              ...
              className="absolute -right-6 -bottom-6 bg-white rounded-lg p-4 shadow-xl w-48 border border-slate-200"
            >
              <div className="flex items-center gap-3">
                ...
                <div>
                  <p className="text-[9px] text-slate-400 uppercase font-bold tracking-wider">Yield Rate</p>
                  <p className="text-xl font-bold text-primary tracking-tight">+18.4%</p>
                </div>
              </div>
            </motion.div>
          </motion.div>
          ...
          >
            <h2 className="text-2xl font-bold text-white tracking-tight leading-tight">Empowering the Future of <br/><span className="text-primary">Sustainable Agriculture</span></h2>
            <p className="text-white/40 text-base font-normal leading-relaxed max-w-md mx-auto">
              Join a global network of investors and farmers. Secure, transparent, and high-yield agricultural opportunities.
            </p>
            ...
            <div className="flex items-center justify-center gap-3 pt-2">
              ...
              <p className="text-white/60 text-xs font-bold tracking-tight">Joined by <span className="text-white font-bold">10k+</span> investors</p>
            </div>
          </motion.div>
        </div>
      </div>
